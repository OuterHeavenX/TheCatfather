...
static func cats() -> Array:
	return [
		{"id": "al_catpone", "name": "Al Catpone", "flavor": "The undisputed boss of the living room rug.", "muscle": 7, "sneak": 5, "charm": 9, "portrait": "sit_01", "tint": TINT_WHITE, "trait": ""},
		{"id": "don_corlemeowne", "name": "Don Corle-meow-ne", "flavor": "Gives offers the dog simply can't refuse.", "muscle": 6, "sneak": 7, "charm": 10, "portrait": "sit_04", "tint": TINT_SILVER, "trait": ""},
		{"id": "johnny_tightlips", "name": "Johnny \"Tight-Lips\"", "flavor": "Never squeals. Not at the vet, not ever.", "muscle": 5, "sneak": 8, "charm": 4, "portrait": "sit_03", "tint": TINT_DARK, "trait": "never_injured"},
		{"id": "sonny_hammer", "name": "Sonny \"The Hammer\"", "flavor": "Crushes his kibble. Swats toys with maximum aggression.", "muscle": 9, "sneak": 3, "charm": 3, "portrait": "sit_02", "tint": TINT_GINGER, "trait": ""},
		{"id": "jimmy_twotimes", "name": "Jimmy \"Two-Times\"", "flavor": "Meows every command twice: \"Treats! Treats!\"", "muscle": 4, "sneak": 4, "charm": 7, "portrait": "sit_happy_01", "tint": TINT_WHITE, "trait": "double_treats"},
		{"id": "lefty_ruggiero", "name": "Lefty \"Ruggiero\"", "flavor": "Always caught on the wrong side of a closed door.", "muscle": 5, "sneak": 3, "charm": 5, "portrait": "sit_03", "tint": TINT_CREAM, "trait": "unlucky"},
		{"id": "lucky_clawciano", "name": "Lucky Claw-ciano", "flavor": "Somehow always lands on his feet after a bad jump.", "muscle": 5, "sneak": 6, "charm": 6, "portrait": "sit_01", "tint": TINT_SILVER, "trait": "lucky"},
		{"id": "frankie_fastpaws", "name": "Frankie \"Fast-Paws\"", "flavor": "Batters toy mice faster than the eye can see.", "muscle": 7, "sneak": 8, "charm": 4, "portrait": "sit_02", "tint": TINT_SILVER, "trait": ""},
		{"id": "vinnie_hook", "name": "Vinnie \"The Hook\"", "flavor": "Belly-rub him past three seconds and find out.", "muscle": 8, "sneak": 5, "charm": 3, "portrait": "sit_04", "tint": TINT_GINGER, "trait": ""},
		{"id": "bugsy_meowsie", "name": "Bugsy Meow-sie", "flavor": "Starts the 3AM zoomies. A beautiful wild card.", "muscle": 6, "sneak": 9, "charm": 6, "portrait": "sit_02", "tint": TINT_WHITE, "trait": ""},
		{"id": "nicky_squeaker", "name": "Nicky \"The Squeaker\"", "flavor": "Looks tough. Speaks only in tiny meows.", "muscle": 2, "sneak": 5, "charm": 8, "portrait": "sit_happy_02", "tint": TINT_CREAM, "trait": ""},
		{"id": "mobby_weasel", "name": "Mobby \"The Weasel\" DeNiro", "flavor": "Into the pantry and out again. Never seen.", "muscle": 3, "sneak": 9, "charm": 6, "portrait": "sit_04", "tint": TINT_DARK, "trait": ""},
