...
static func cats() -> Array:
	return [
		...
		{"id": "sammy_bull", "name": "Sammy \"The Bull\"", "flavor": "Shoulders the door, shoulders the blame. Built like a fridge.", "muscle": 10, "sneak": 2, "charm": 4, "portrait": "mob/head/sammy_bull", "tint": TINT_WHITE, "trait": "", "role": "muscle", "recruitable": true},
		...
		{"id": "carmela", "name": "Carmela", "flavor": "The real boss. Runs everything behind the scenes.", "muscle": 6, "sneak": 7, "charm": 9, "portrait": "mob/head/carmela", "tint": TINT_WHITE, "trait": "", "role": "boss", "recruitable": false},
